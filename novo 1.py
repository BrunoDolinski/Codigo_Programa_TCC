...
while(True):
    if __name__ == "__main__":
        counter += 1                #incrementa um dado no contador a cada ciclo, contando a quantidade de dados recebida
        k = 0
        ...
        #Verifica se a quantidade desejada de dados foi atingida, se sim, para de receber dados
        if (counter >= qtdDados):
                k = 1
                break
